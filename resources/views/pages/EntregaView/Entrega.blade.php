...
<form>
    <div class="form-horizontal">
        ...
        <div class="col-sm-6">
            <input type="text" id="envid" class="form-control" placeholder="ID" name="enid">
            </div>
        </div>
        ...
        <select class="form-control" id="traplaca" name="traplaca">
            <option>escoger transporte</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
            <input class="date form-control"  type="text" id="datepicker" name="enfechacreacion">
                </div>
            <div class="col-sm-1">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
            <input class="date form-control"  type="text" id="datepicker2" name="enfechaentrega">
                </div>
            <div class="col-sm-1">
            <span class="glyphicon glyphicon-calendar"></span>
                </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="endetalles" placeholder="Detalles" name="endetalles">
            </div>
        </div>
...
<div class="form-row">
    <div class="form-group col-md-12">
        <button type="button" id="añadir" class="btn btn-success " data-toggle="modal" data-target="#envios">Añadir Envios</button>
    </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" form="form1" id="envid" name="envid" readonly>
            </div>
        </div>
        ...
        <div class="col-sm-6">
        <input type="text" class="form-control" form="form1" id="enprecio"  name="enprecio" readonly>   
            </div>
        </div>
