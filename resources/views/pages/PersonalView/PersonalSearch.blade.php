...
<br/>
 <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="percedula" value="{{$persona->PERCEDULA}}" name="percedula">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="pernombre" value="{{$persona->PERNOMBRE}}" name="pernombre">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="perapellido" value="{{$persona->PERAPELLIDO}}" name="perapellido">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="percargo" value="{{$persona->PERCARGO}}" name="percargo">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
            <input class="date form-control"  type="text" id="datepicker" value="{{$persona->PERFECHANACIMIENTO}}" name="perfechanacimiento">
                </div>
            <div class="col-sm-1">
