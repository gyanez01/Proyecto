...
<br/>
 <div class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="eqcodigo" placeholder="Codigo" name="eqcodigo">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="eqnombre" placeholder="Nombre" name="eqnombre">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="eqdescripcion" placeholder="Descripcion" name="eqdescripcion">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
            <input class="date form-control"  type="text" id="datepicker" name="eqfechaadquicision">
                </div>
            <div class="col-sm-1">
