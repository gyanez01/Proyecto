...
<br/>
 <div class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="rolid" placeholder="ID" name="rolid">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
            <input class="date form-control"  type="text" id="datepicker" name="rolfecha">
                </div>
            <div class="col-sm-1">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="rolingreso" placeholder="Ingresos" name="rolingreso">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="roldescuento" placeholder="Descuentos" name="roldescuento">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="rolvalortotal" placeholder="Total" name="rolvalortotal" readonly>
            </div>
        </div>
