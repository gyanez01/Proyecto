...
<br/>
 <div class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="traplaca" placeholder="Placa" name="traplaca">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="tramarca" placeholder="Marca" name="tramarca">
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control" id="tratipo" placeholder="Tipo" name="tratipo">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
            <input class="date form-control"  type="text" id="datepicker" name="traanio">
                </div>
            <div class="col-sm-1">
